...
class AppConfig:
    ...
    def _load_providers(cls, providers_env: str) -> Dict[str, ProviderConfig]:
        ...
        providers = {
            ...
            "modelset": ProviderConfig(
                name="modelset",
                origin="https://console.modelset.top",
                login_path="/sign-in",
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",
            ...
            "nianhuaapi": ProviderConfig(
                name="nianhuaapi",
                origin="https://us-3.nianhuaapi.com",
                login_path="/login",
                status_path="/api/status",
                auth_state_path="/api/oauth/state",
                check_in_path="/api/user/checkin",
